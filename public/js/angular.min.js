...
(function (w) {
    ...
    function oe(a) {
        if (B(a))
            u(a.objectMaxDepth) &&
                (Mc.objectMaxDepth = Wb(a.objectMaxDepth)
                    ? a.objectMaxDepth
                    : NaN);
        else return Mc;
    }
    ...
    function we(a, b) {
        ...
        d &&
            (xe
                ? ((e.strictDi = null !== ve(d, "strict-di")),
                  b(d, c ? [c] : [], e))
                : w.console.error(
    ...
    function oc(a, b) {
        ...
        c &&
            (b
                ? delete c.data[b]
                : (c.handle &&
                      (c.events.$destroy && c.handle({}, "$destroy"), hd(a)),
                  delete ib[d],
                  (a.ng339 = void 0)));
    }
    function zb(a, b) {
            ...
            function c(a) {
                ...
                var g = b.template || b.templateUrl ? b.template : "",
                    f = {
                        controller: d,
                        controllerAs:
                            sg(b.controller) || b.controllerAs || "$ctrl",
                        template: e(g),
        ...
        this.$get = [
            ...
            function (a, b, c, e, p, R, M, T, P, q) {
                ...
                function Y(a, b, d, e, g, f, h, k, l) {
                    ...
                    function p(a, e, g, f, l) {
                        ...
                        for (n in M) {
                            ...
                            if (F) {
                                v.bindingInfo = P
                                    ? qa(ba, f, v.instance, P, s)
                                    : {};
                                var q = v();
                                q !== v.instance &&
                                    ((v.instance = q),
                                    ga.data("$" + s.name + "Controller", q),
                                    v.bindingInfo.removeWatches &&
                                        v.bindingInfo.removeWatches(),
                                    (v.bindingInfo = qa(
                                        ba,
                                        f,
                        ...
                        for (s = h.length; n < s; n++)
                            (v = h[n]),
                                va(
                                    ...
                                    f,
                                    v.require &&
                                        X(v.directiveName, v.require, ga, M),
                                    R
                                );
                        var N = e;
                        ...
                        if (s.templateUrl)
                            ...
                            try {
                                ...
                                C(N)
                                    ? m(null, Ra(U, N), Ta, E)
                                    : N &&
                                      m(Ra(U, N.pre), Ra(U, N.post), Ta, E);
                            } catch ($) {
                                c($, za(v));
                            }
                        s.terminal &&
                            ((p.terminal = !0), (n = Math.max(n, s.priority)));
                    }
                    p.scope = t && !0 === t.scope;
                ...
                function ma(a, b, c) {
                    ...
                    z.hasData(d) &&
                        (z.data(c, z.data(d)), z(d).off("$destroy"));
    ...
    function qd(a) {
        ...
        for (; b--; ) {
            var d = a[b];
            (8 === d.nodeType ||
                (d.nodeType === Oa && "" === d.nodeValue.trim())) &&
                ug.call(a, b, 1);
        }
        return a;
    }
                ...
                function n(c, d) {
                    ...
                    x(T) &&
                        ((T = zd(c.url)
                            ...
                            : void 0) &&
                            (P[c.xsrfHeaderName || a.xsrfHeaderName] = T),
                        e(
                            c.method,
                            N,
                            d,
        ...
        return function (e, h, k, l, m, p, n, F, s, v) {
            ...
            if ("jsonp" === L(e))
                ...
                A.onload = function () {
                    ...
                    0 === c &&
                        (c = b ? 200 : "file" === ta(h).protocol ? 404 : 0);
        ...
        this.$get = [
            ...
            function (d, c, e, f, g) {
                ...
                if (b.enabled) {
                    ...
                    n =
                        p.substring(0, p.indexOf("/", p.indexOf("//") + 2)) +
                        (m || "/");
                    m = e.history ? yc : Cd;
                } else (n = La(p)), (m = zc);
    ...
    function Mf() {
        ...
        this.$get = [
            ...
            function (d) {
                ...
                var f =
                    Ca || /\bEdge\//.test(d.navigator && d.navigator.userAgent);
                return {
                    log: e("log"),
                    info: e("info"),
                    warn: e("warn"),
    ...
    function Qd(a) {
        ...
        return function (a, c, e) {
            ...
            return null == a
                ? a
                : Ud(a, b.PATTERNS[1], b.GROUP_SEP, b.DECIMAL_SEP, e).replace(
                      f,
                      c
                  );
        };
    ...
    var I = Array.isArray,
        ...
        xe = (function (a) {
            ...
            if (
                !(
                    b instanceof w.HTMLScriptElement ||
                    b instanceof w.SVGScriptElement
                )
            )
                return !1;
            b = b.attributes;
    ...
    r(
        {
            ...
            isolateScope: function (a) {
                return (
                    z.data(a, "$isolateScope") ||
                    z.data(a, "$isolateScopeNoTemplate")
                );
            },
            controller: id,
            injector: function (a) {
            ...
            on: function (a, b, d, c) {
                ...
                if (jc(a)) {
                    ...
                    for (
                        ...
                        (b = c[g]),
                            Ab[b] ? (h(Ab[b], kg), h(b, void 0, !0)) : h(b);
                }
            },
            off: hd,
            one: function (a, b, d) {
        ...
        Cf = function () {
            this.$get = [
                ...
                function (a) {
                    return function (b) {
                        b
                            ? !b.nodeType && b instanceof z && (b = b[0])
                            : (b = a[0].body);
